---
title: "GraphRAG SDK Multi-Path Retrieval"
sidebarTitle: "Retrieval"
description: "How GraphRAG SDK's multi-path retrieval combines vector search, Cypher generation, and entity discovery -- run concurrently where possible -- into one grounded context."
---
