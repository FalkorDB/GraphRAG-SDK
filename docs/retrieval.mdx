---
title: "GraphRAG SDK Retrieval: Multi-Path Knowledge Graph Search"
sidebarTitle: "Retrieval"
description: "How GraphRAG SDK answers questions with five parallel retrieval paths -- vector search, Cypher generation, and entity discovery -- merged into one grounded context."
---
