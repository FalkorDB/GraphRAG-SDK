---
title: "GraphRAG-Bench Methodology and Reproduction"
sidebarTitle: "Benchmark"
description: "Full GraphRAG-Bench methodology behind GraphRAG SDK's 71.48 overall score, with per-category results and reproduction instructions."
---
...
<Note>
For the headline comparison against vector RAG (71.48 vs 55.39), the citation
block and what a benchmark does and does not tell you about production
hallucinations, see
[GraphRAG Accuracy Benchmark: FalkorDB vs Vector RAG](/graphrag-accuracy-benchmark).
This page is the deep methodology reference behind those numbers.
</Note>
