---
title: "Entity and Relation Extraction in GraphRAG SDK"
sidebarTitle: "Extraction"
description: "How GraphRAG SDK's LLM-based extraction turns raw text chunks into typed entities and the relationships between them."
---
