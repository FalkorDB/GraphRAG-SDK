---
title: "GraphRAG SDK Architecture: Ingestion and Retrieval"
sidebarTitle: "Architecture"
description: "How GraphRAG SDK's strategy-based ingestion and retrieval pipelines fit together, with every algorithmic step as a swappable ABC."
---
