---
title: "GraphRAG SDK Pipeline Architecture"
sidebarTitle: "Architecture"
description: "How GraphRAG SDK's strategy-based ingestion and retrieval pipelines fit together, with pluggable ABCs for extraction, resolution, chunking, and loading."
---
...
- [Ingestion Pipeline](/ingestion) — the 9-step pipeline from document to knowledge graph
- [Extraction](/extraction) — the 2-step hybrid extraction process (NER + LLM)
