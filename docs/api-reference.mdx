...
**Built-in:**
- `LLMVerifiedResolution(llm=None, embedder=None, hard_threshold=0.95, soft_threshold=0.65, batch_verification=True, verification_max_pairs_per_call=5, ...)` — default
