...
class OrchestratorResult(StepResult):
    ...
    def from_json(json: dict) -> "OrchestratorResult":
        """
        Create an OrchestratorResult instance from a JSON dictionary.

        Args:
            json (dict): The input dictionary containing the output data.

        Returns:
            OrchestratorResult: An instance of OrchestratorResult.
        """
...
class OrchestratorRunner:
    ...
    Attributes:
        _chat (GenerativeModelChatSession): The chat session used for communication with the model.
        _agents (list[Agent]): List of registered agents for executing tasks.
        _plan (ExecutionPlan): The execution plan that dictates the steps to be executed.
        _user_question (str): The user's original question.
        _config (dict): Configuration settings for the orchestrator.
        _runner_log (list[tuple[PlanStep, StepResult]]): Log of steps executed and their results.
        _agent_sessions (dict[str, GenerativeModelChatSession]): Sessions for each agent.
    """
