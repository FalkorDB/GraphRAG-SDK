...
| **Resolution** | `ResolutionStrategy` | `ExactMatchResolution`, `LLMVerifiedResolution` | `ExactMatch` at ingest; `LLMVerifiedResolution` + LLM-judged cross-document dedup in `finalize()` |
